...
worksheets <- purrr::map2(.x = rep_years,
                          .y = rep_types,
...
tidy_args <- list(worksheet = worksheets,
                  year = rep_years,
                  type = rep_types)
tidy_dfs <- purrr::pmap(tidy_args,
                        function(worksheet, year, type) tidy_worksheet(worksheet, year, type)
                        )

year_of_birth <- dplyr::bind_rows(tidy_dfs)
